...
#SBATCH --gres=gpu:1
#SBATCH --output=brunel_iaf_psc_exp_odeint_%j.out
#SBATCH --error=brunel_iaf_psc_exp_odeint_%j.err
...
python3 /p/project1/cslns/natouf1/test_brunel_iaf_psc_exp_neuron_nestml.py ${N_NEURONS}
