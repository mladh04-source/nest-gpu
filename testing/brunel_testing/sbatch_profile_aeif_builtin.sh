...
#SBATCH --gres=gpu:1
#SBATCH --output=profile_aeif_builtin_%j.out
#SBATCH --error=profile_aeif_builtin_%j.err
...
mkdir -p /p/project1/cslns/natouf1/profile_aeif_builtin_1000
...
OUT_BASE="/p/project1/cslns/natouf1/nsys_brunel_reports/aeif_builtin_1000_nodelay"
...
nsys profile \
  ...
  python3 -u /p/project1/cslns/natouf1/test_brunel_compare_overlay.py \
    ...
    --n-neurons 1000 \
    --sim-time 60000.0 \
    --outdir /p/project1/cslns/natouf1/profile_aeif_builtin_1000
