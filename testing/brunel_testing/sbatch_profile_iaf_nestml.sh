...
#SBATCH --gres=gpu:1
#SBATCH --output=profile_iaf_nestml_%j.out
#SBATCH --error=profile_iaf_nestml_%j.err
...
mkdir -p /p/project1/cslns/natouf1/profile_iaf_nestml_1000
...
nsys profile \
  ...
  -o /p/project1/cslns/natouf1/nsys_brunel_reports/iaf_nestml_1000 \
  python3 /p/project1/cslns/natouf1/test_brunel_compare_overlay.py \
    ...
    --n-neurons 1000 \
    --sim-time 1000.0 \
    --outdir /p/project1/cslns/natouf1/profile_iaf_nestml_1000
