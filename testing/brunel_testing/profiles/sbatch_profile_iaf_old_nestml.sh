...
RUN_BASE="/p/project1/cslns/natouf1/nsys_profiles/iaf_old_nestml"
...
do
  echo "========================================"
  echo "Profiling IAF old NESTML with ${N} neurons"
  echo "========================================"

  RUN_DIR="${RUN_BASE}/${N}"
  OUT_BASE="${RUN_DIR}/iaf_old_nestml_${N}_2024_nsys"
  ...
  do
    ...
    "$NSYS" stats \
      ...
      --format csv \
      "${OUT_BASE}.nsys-rep" \
      | tee "${RUN_DIR}/iaf_old_nestml_${N}_${REPORT}.csv"
  done
done
