...
RUN_BASE="/p/project1/cslns/natouf1/nsys_profiles/aeif_builtin"
...
do
  echo "========================================"
  echo "Profiling AEIF builtin with ${N} neurons"
  echo "========================================"

  RUN_DIR="${RUN_BASE}/${N}"
  OUT_BASE="${RUN_DIR}/aeif_builtin_${N}_2024_nsys"
  ...
  do
    ...
    "$NSYS" stats \
      ...
      --format csv \
      "${OUT_BASE}.nsys-rep" \
      | tee "${RUN_DIR}/aeif_builtin_${N}_${REPORT}.csv"
  done
done
