 ...
 *
 *  Generated from NESTML 8.3.0-rc3-post-dev at time: 2026-06-28 07:18:36.945900
 */
              ...
              aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  ...
  param[i_V_th] = -50.4;
  param[i_V_peak] = 0.0;
  param[i_tau_syn_exc] = 0.2;
  param[i_tau_syn_inh] = 2.0;
  param[i_E_exc] = 0.0;
  param[i_E_inh] = -85.0;
  param[i_I_e] = 0.0;
  param[i___h] = 0.1;
                                      ...
                                      aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  ...
  dydx[i_w] =
    (param[i_a] * ((-param[i_E_L]) + min(y[i_V_m], param[i_V_peak])) - y[i_w])
    / param[i_tau_w];
                                   ...
                                   aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  ...
  dydx[i_V_m] =
    (
      ...
      + param[i_I_e]
      + param[i_I_stim]
      - param[i_g_L] * ((-param[i_E_L]) + min(y[i_V_m], param[i_V_peak]))
      - y[i_g_exc] * ((-param[i_E_exc]) + min(y[i_V_m], param[i_V_peak]))
      - y[i_g_inh] * ((-param[i_E_inh]) + min(y[i_V_m], param[i_V_peak]))
      - y[i_w]
    ) / param[i_C_m];
...
//new: changed the if statement from if (y[i_refr_t] <= 0.0 && y[i_V_m] >= param[i_V_peak])
...
void NodeInit(int n_var,
              ...
              aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  aeif_cond_alpha_alt_neuron_nestml_ns::NodeInit(
    n_var,
    n_param,
    x,
    y,
...
void NodeCalibrate(int n_var,
                   ...
                   aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  aeif_cond_alpha_alt_neuron_nestml_ns::NodeCalibrate(
    n_var,
    n_param,
    x,
    y,
                 ...
                 aeif_cond_alpha_alt_neuron_nestml_rk5 data_struct)
{
  if (y[i_refr_t] > 0.0)
  {
    aeif_cond_alpha_alt_neuron_nestml_ns::
...
{ 
  ...
  group_param_name_ =
    aeif_cond_alpha_alt_neuron_nestml_group_param_name;
