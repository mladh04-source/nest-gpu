...
mkdir -p /p/project1/cslns/natouf1/profile_aeif_old_nestml_1000
...
nsys profile \
  ...
  -o /p/project1/cslns/natouf1/nsys_brunel_reports/aeif_old_nestml_1000 \
  python3 /p/project1/cslns/natouf1/test_brunel_compare_overlay_old_nestml.py \
    ...
    --n-neurons 1000 \
    --sim-time 1000.0 \
    --outdir /p/project1/cslns/natouf1/profile_aeif_old_nestml_1000
