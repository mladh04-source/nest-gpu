...
#include "rk5.h"
#include "odeint_thrust_solver.h" // NEW: experimental solver
#include "node_group.h"
#include "base_neuron.h"
#include "neuron_models.h"

// ================= EXPERIMENT SWITCH =================
// 0 → original RK5 (correct NEST GPU behavior)
// 1 → Boost.odeint + Thrust (demonstrates incompatibility)
...
public:
  ...
  // Experimental solver (host-driven, global step)
  OdeintThrustSolver<N_SCAL_VAR + N_PORT_VAR>* odeint_solver_;
#endif
...
// I changed this a little 
  int GetX(int i_neuron, int n_node, double *x) {
    ...
    #if USE_ODEINT_THRUST
  // odeint stores state differently.
  // Direct access via RK5 is invalid.
  return -1;
#else
